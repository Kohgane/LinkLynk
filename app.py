...
def gift_config_api():
    ...
    resp = jsonify({"ok": True,
                    ...
                    "questions": [
                        {"id": "rel", "step": "1/3 받는 분", "t": "누구에게 주나요?", "type": "single",
                         "opts": ["부모님", "연인", "친구", "직장 동료·상사", "형제·자매", "아이·조카", "선생님·은사", "나 자신"]},
                        {"id": "a", "step": "1/3 받는 분", "t": "나이대는요?", "type": "single",
                         "opts": ["10", "20", "30", "40", "50", "60", "모름"],
                         "labels": ["10대", "20대", "30대", "40대", "50대", "60대 이상", "잘 모르겠어요"]},
                        {"id": "g", "step": "1/3 받는 분", "t": "성별은요?", "type": "single",
                         "opts": ["여", "남", ""], "labels": ["여성", "남성", "상관없어요"]},
                        {"id": "close", "step": "1/3 받는 분", "t": "얼마나 가까운 사이인가요?", "type": "single",
                         "opts": ["아주 가까움 — 뭘 줘도 되는 사이", "편한 사이 — 부담 없이", "예의를 갖출 사이", "잘 모르는 사이"]},
                        {"id": "occ", "step": "2/3 상황", "t": "어떤 자리인가요?", "type": "single",
                         "opts": ["생일", "기념일", "집들이", "감사 인사", "승진·취업 축하", "결혼·출산", "명절", "그냥, 문득"]},
                        {"id": "budget", "step": "2/3 상황", "t": "예산은 어느 정도?", "type": "single",
                         "opts": ["1만원 이하", "1~3만원", "3~5만원", "5~10만원", "10~20만원", "20만원 이상"]},
                        {"id": "when", "step": "2/3 상황", "t": "언제 필요한가요?", "type": "single",
                         "opts": ["오늘·내일 — 급해요", "이번 주 안", "여유 있어요"]},
                        {"id": "vibe", "step": "3/3 취향", "t": "받는 분은 어떤 사람?", "type": "single",
                         "opts": ["실용파 — 쓸모가 최고", "감성파 — 예쁜 게 최고", "미니멀 — 물건 적은 편", "맥시멀 — 모으는 재미", "트렌디 — 요즘 것", "클래식 — 오래 가는 것"]},
                        {"id": "cats", "step": "3/3 취향", "t": "끌릴 만한 분야는? (복수 선택)", "type": "multi", "max": 3,
                         "opts": ["홈카페·차", "향·캔들", "주방·리빙", "문구·데스크", "술·잔", "패션잡화", "바디·그루밍", "오디오·아날로그", "아웃도어·운동", "게임·취미"]},
                        {"id": "nocats", "step": "3/3 취향", "t": "이건 피할까요? (복수 선택)", "type": "multi", "max": 3,
                         "opts": ["먹는 것", "향 나는 것", "몸에 닿는 것", "전자기기", "장식품", "없음 — 다 좋아요"]},
                        {"id": "who", "step": "3/3 취향", "t": "이 사람, 한마디로 어떤 분인가요?", "type": "text",
                         "ph": "예: 땀이 많아요 / 캠핑 좋아함 / 자취 시작 / 손이 작아요 / 이미 텀블러 있음",
